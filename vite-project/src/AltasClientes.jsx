...
export const AltasClientes = () => {
    ...
    const onSubmit = async (event) => {
        ...
        const parametros = `id=${id}&nombre=${nombre}&apellidos=${apellidos}&correo=${correo}`;
        console.log(`http://localhost/proyecto1/php/GestionCliente.php?${parametros}`);

        try {
            const response = await fetch(`http://localhost/proyecto1/php/GestionCliente.php?${parametros}`, {
                method: 'GET',
                headers: {
